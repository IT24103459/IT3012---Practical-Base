...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None):
        ...
        # Step 2.1: a hidden hazard the agent's sensors do NOT report by
        # default (see get_percept) — used to explore observability.
    ...
    def get_percept(self) -> dict:
        return {
            ...
            # Required by SearchAgent (Practical 03 Step 1.1 / Practical 04):
    ...
    def execute_action(self, action: str):
        ...
        # 'Stay' (or None / unrecognized action) leaves new_pos unchanged
...
class GridGameGUI:
    ...
    def __init__(self, root, width=10, height=10, num_food=12, num_opponents=2, walls=None, agent=None):
        ...
        # Step 1.3.5: inject a real agent (SearchAgent) instead of driving the
        # simulation with a hardcoded random walk. Defaults to SearchAgent/BFS
        # if no agent is supplied.
        if agent is None:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            mx = (x1 + x2) / 2
            # purple diamond marks a toxic trap
...
if __name__ == "__main__":
    ...
    my_agent.active_algo = 'AStar'   # try 'BFS', 'DFS', 'UCS', or 'AStar'

    # Try a larger grid size like 12x12 with 15 food and 3 opponents!
    app = GridGameGUI(root, width=12, height=12, num_food=15, num_opponents=0, agent=my_agent)
    root.mainloop()
